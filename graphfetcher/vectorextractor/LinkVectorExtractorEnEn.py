...
class LinkVectorExtractorEnEn(object):
    ...
    def __export_to_file(self, _root_url, _output_fname, _entry_list):
        ...
        outfile.write(u'# item size: ' + str(len(_entry_list)) + '\n');
    ...
    def get_link_list(self, _root_url, _output_fname):
        ...
        try:
            ...
            entry_list = []
            entry_set = set()           # for duplication check
            for link in linklist:
                ...
                if (self.__can_add_entry(atag) == False):
                    ...
                    # check duplication
                    if (self.__is_duplicated(entry_set, href_item) == False):
                        # Adding to the output entry list
                        entry_list.append(href_item)
                        entry_set.add(href_item)
                    else:

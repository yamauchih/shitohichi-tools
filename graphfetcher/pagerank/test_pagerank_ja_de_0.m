%TEST_PAGERANK_JA_DE_0 pagerank computation for ja_de
%

clear

% data
vector_fname = '/../vectorextractor/baseline/ja_de_writer.ascii.vector';
res_author_fname = 'pagerank_result/ja_de_writer.author.vector'; 
res_data_fname   = 'pagerank_result/ja_de_writer.pagerank.data'; 

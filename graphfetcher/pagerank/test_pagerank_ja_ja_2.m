%TEST_PAGERANK_JA_JA_0 pagerank computation for ja_ja
%

clear

% data
vector_fname = '/../vectorextractor/baseline/ja_ja_writer.ascii.vector';
res_author_fname = 'pagerank_result/ja_ja_writer_with_navbox.author.vector'; 
res_data_fname   = 'pagerank_result/ja_ja_writer_with_navbox.pagerank.data'; 
...
%
madj = ja_ja_writer_adj_mat_with_navbox();

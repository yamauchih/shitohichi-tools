%TEST_PAGERANK_EN_JA_0 pagerank computation for en_ja
%

clear

% data
vector_fname = '/../vectorextractor/baseline/en_ja_writer.ascii.vector';
res_author_fname = 'pagerank_result/en_ja_writer.author.vector'; 
res_data_fname   = 'pagerank_result/en_ja_writer.pagerank.data'; 

%TEST_PAGERANK_ITALIAN_EN_0 pagerank computation for italian_en
%

clear

% data
vector_fname = '/../vectorextractor/baseline/italian_en_writer.ascii.vector';
res_author_fname = 'pagerank_result/italian_en_no_navbox_writer.author.vector'; 
res_data_fname   = 'pagerank_result/italian_en_no_navbox_writer.pagerank.data'; 
...
%
madj = italian_en_no_navbox_writer_adj_mat();

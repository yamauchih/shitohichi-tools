%TEST_PAGERANK_JA_EN_0 pagerank computation for ja_en
%

clear

% data
vector_fname = '/../vectorextractor/baseline/ja_en_writer.ascii.vector';
res_author_fname = 'pagerank_result/ja_en_writer.author.vector'; 
res_data_fname   = 'pagerank_result/ja_en_writer.pagerank.data'; 

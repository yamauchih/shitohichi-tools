%TEST_PAGERANK_EN_DE_0 pagerank computation for en_de
%

clear

% data
vector_fname = '/../vectorextractor/baseline/en_de_writer.ascii.vector';
res_author_fname = 'pagerank_result/en_de_writer.author.vector'; 
res_data_fname   = 'pagerank_result/en_de_writer.pagerank.data'; 

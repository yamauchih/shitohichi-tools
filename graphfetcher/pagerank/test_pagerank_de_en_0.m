%TEST_PAGERANK_DE_EN_0 pagerank computation for de_en
%

clear

% data
vector_fname   = '/../vectorextractor/baseline/de_en_writer.ascii.vector';
res_author_fname = 'pagerank_result/de_en_writer.author.vector'; 
res_data_fname   = 'pagerank_result/de_en_writer.pagerank.data'; 

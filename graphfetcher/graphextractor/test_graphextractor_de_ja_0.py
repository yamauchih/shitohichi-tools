...
"""
\file
\brief GraphExtractor test: de_ja (Deutsche writer on Japanese wiki)
"""
...
class TestGraphExtractor(unittest.TestCase):
    ...
    def test_graphextractor(self):
        """test graph (adjacent matrix) extractor. de_ja Deutsche Writer, Japanese Wiki"""
        # print u'# Need LC_ALL setting to utf-8, e.g., en_US.utf-8, ja_JP.utf-8.'
        graphfetcherdir    = u'/home/hitoshi/data/project/shitohichi-tools/graphfetcher/'
        input_rpath        = u'data/german_writer/ja.wikipedia.org/'
        output_rpath       = u'data/german_writer/ja.wikipedia.org/'
        input_vector_fname = u'de_ja_writer.utf-8.vector'
        output_madj_fname  = u'de_ja_writer_adj_mat.m'
        ...
        opt_dict = {
            ...
            'dot_file_name': 'de_ja_writer_adj_mat.dot',
